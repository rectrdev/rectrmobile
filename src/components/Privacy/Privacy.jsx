    ...
    <>
      <div className="privacydata">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to Rectr, the software program
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Rectr, 68 D, Mailam Road, TIndivanam,
              Tamilnadu.
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: Sresanjai.founder@rectr.in</li>
        </ul>
      </div>
    </>
  );
